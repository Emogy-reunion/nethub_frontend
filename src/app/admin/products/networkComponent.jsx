...
export default function NetworkComponent({ data, group, category }) {
                                                ...
                                                products.map((product) => (
                                                        <div key={product.product_id} className={styles.card}>
                                                                <div className={styles.cardImage}>
                                                                        <Link href={`/admin/products/details/${product.product_id}`} className={styles.imageLink}>
                                                        ...
                                                        alt={product.name}
                                                                ...
                                                                <div className={styles.cardBody}>
                                                                        <Link href={`/admin/products/details/${product.product_id}`} className={styles.cardTitle}>
                                                                                {product.name}
                                                                        </Link>
